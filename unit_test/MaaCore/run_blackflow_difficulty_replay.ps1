...
if (!$OutputDirectory) { $OutputDirectory = Join-Path $repo 'build\blackflow-difficulty-replay' }
...
$generatorArgs = @((Join-Path $PSScriptRoot 'generate_blackflow_difficulty_replay.py'), (Join-Path $out 'replay.cpp'))
